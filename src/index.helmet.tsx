...
const ReactApp = () => (
    <>
        <Helmet>
            ...
            <meta title="Michael Eze, Eze, Michael, Software engineer, frontend, portfolio, developer, typescript, React, node, full-stack, UI, UX" />
            <meta name="description" content="Michael Eze is a passionate Software Engineer | FrontEnd and full-stack React developer also skilled in UI designing based in Germany. Hobbies are programming, dancing, music, cooking and sports(basket ball and football)"/>
          ...
          <link rel="icon" href="%PUBLIC_URL%/me.jpg" />
            ...
            <link rel="apple-touch-icon" href="%PUBLIC_URL%/me.jpg"/>
